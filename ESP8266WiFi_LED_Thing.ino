...
unsigned long channel_num=1252978;

const char* ssid = "TP-Li.....";
const char* pass = "6.....";
...
void setup()
{
 ...
 Serial.begin(115200);
 WiFi.begin(ssid,pass);    // connect to the wifi STA connection
...
String SendHTML(void){
 ...
 ptr +="<a class=\"button button-on\" href=\"https://api.thingspeak.com/update?api_key=R6F....EZP3SA&field1=1\">ON</a>\n";
 ptr +="<a class=\"button button-off\" href=\"https://api.thingspeak.com/update?api_key=R6F...ZP3SA&field1=0\">OFF</a>\n";
 ptr +="</body>\n";
 ptr +="</html>\n";
 return ptr;
}
